...
if( $global_perms & GPERM_INSERTABLE ) $GLOBALS['xoopsTpl']->assign( 'lang_add_photo' , _ALBM_ADDPHOTO ) ;
...
if( $cid > 0 ) {
	...
	$GLOBALS['xoopsTpl']->assign( 'subcategories' , myalbum_get_sub_categories( $cid , $GLOBALS['cattree'] ) ) ;	$GLOBALS['xoopsTpl']->assign( 'category_options' , myalbum_get_cat_options() ) ;
	...
	// uid Specified
		...
		$GLOBALS['xoopsTpl']->assign( 'album_sub_title' , "<img src='$mod_url/images/myphotos.gif' alt='' />" . myalbum_get_name_from_uid( $uid ) ) ;
	}
