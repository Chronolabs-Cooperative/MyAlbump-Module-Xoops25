...
if (!$GLOBALS['xoopsTpl']->is_cached('db:'.$GLOBALS['mydirname'].'_rss.html')) {
	...
	if( $cid > 0 ) {
		...
		$sub_title = preg_replace( "/\'\>/" , "'><img src='$mod_url/images/folder16.gif' alt='' />" , $GLOBALS['cattree']->getNicePathFromId( $cid , 'title' , "viewcat.php?num=$num" ) ) ;
...
$GLOBALS['xoopsTpl']->display('db:'.$GLOBALS['mydirname'].'_rss.html');
?>