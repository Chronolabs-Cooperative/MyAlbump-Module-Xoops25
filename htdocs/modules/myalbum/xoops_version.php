...
$modversion['author'] = "Wishcraft=Simon Roberts<br />Chronolabs Co-op.(http://www.chronolabs.coop/)" ;
$modversion['credits'] = "Original: Daniel Branco<br />(http://bluetopia.homeip.net)<br />Kazumi Ono<br />(http://www.mywebaddons.com/)<br />The XOOPS Project, Chronolabs Co-op - http://www.chronolabs.coop/" ;
$modversion['help'] = "" ;
...
$modversion['support_site_url'] = "http://www.chronolabs.coop/forums/viewforum.php?forum=30";
$modversion['support_site_name'] = "Chronolabs";
$modversion['submit_bug'] = "http://www.chronolabs.coop/forums/viewforum.php?forum=30";
$modversion['submit_feature'] = "http://www.chronolabs.coop/forums/viewforum.php?forum=30";
...
$modversion['templates'][12]['file'] = "{$mydirname}_cpanel_admission.html" ;
$modversion['templates'][12]['description'] = '';
$modversion['templates'][13]['file'] = "{$mydirname}_cpanel_batch.html" ;
$modversion['templates'][13]['description'] = '';
$modversion['templates'][14]['file'] = "{$mydirname}_cpanel_export.html" ;
$modversion['templates'][14]['description'] = '';
$modversion['templates'][15]['file'] = "{$mydirname}_cpanel_import.html" ;
$modversion['templates'][15]['description'] = '';
$modversion['templates'][16]['file'] = "{$mydirname}_cpanel_permissions.html" ;
$modversion['templates'][16]['description'] = '';
$modversion['templates'][17]['file'] = "{$mydirname}_rss.html" ;
