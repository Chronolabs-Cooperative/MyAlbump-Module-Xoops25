...
{
	if( empty( $table_name_cat ) ) $table_name_cat = $GLOBALS['xoopsDB']->prefix($GLOBALS['table_cat']) ;
	if( empty( $table_name_photos ) ) $table_name_photos = $GLOBALS['xoopsDB']->prefix($GLOBALS['table_photos']) ;
